...
In addition, due to the requirement of CRAN that general packages should not exceed 5MB, the **_s_**upplemental **_w_**orkbook **_o_**r **_r_**eference **_d_**atasets (**_sword_**) required by **_vigilante & knights_** have been extracted and put in the standalone package **_vigilante.knights.sword_**. Please check [vigilante.knights.sword](https://github.com/yilixu/vigilante.knights.sword) for more information.
